...
import type { RouterClient as _routerrpc_RouterClient, RouterDefinition as _routerrpc_RouterDefinition } from './routerrpc/Router';
...
export interface ProtoGrpcType {
  lnrpc: {
    ...
    GetDebugInfoRequest: MessageTypeDefinition
    GetDebugInfoResponse: MessageTypeDefinition
    ...
    InstantUpdate: MessageTypeDefinition
    ...
    LookupHtlcResolutionRequest: MessageTypeDefinition
    LookupHtlcResolutionResponse: MessageTypeDefinition
